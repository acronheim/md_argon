...
\insertcode{"Scripts/pair_correlation_snippet_2.f90"}{Factors are needed to prevent oeverflow errors} % The first argument is the script location/filename and the second is a caption for the listing
