...
\begin{figure}[tb]
\centering
\subfloat[Pair correlation function of Argon($\rho = 0.88$, $T=0.2$) ]{\includegraphics[width=.45\columnwidth]{histogramrho088T02}} \quad
\subfloat[Pair correlation function of Argon($\rho = 0.88$, $T=0.4$) ]{\includegraphics[width=.45\columnwidth]{histogramrho088T04}\label{fig:ipsum}} \\
\subfloat[Pair correlation function of Argon($\rho = 0.88$, $T=0.6$) ]{\includegraphics[width=.45\columnwidth]{histogramrho088T06}} \quad
\subfloat[Pair correlation function of Argon($\rho = 0.88$, $T=0.8$) ]{\includegraphics[width=.45\columnwidth]{histogramrho088T08}}
